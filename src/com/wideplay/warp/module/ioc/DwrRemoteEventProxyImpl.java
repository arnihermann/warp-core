...
class DwrRemoteEventProxyImpl implements RemoteEventProxy {
    ...
    public String dispatchEvent(Map<String, String> params) {
        ...
        LogFactory.getLog(RemoteEventProxy.class).debug(params);
        ...
        ComponentSupport.renderMultiple(htmlWriter, obtainFrameNestedContent(rootComponentHandler.getNestedComponents()),
                injector, reflection, page
        );
