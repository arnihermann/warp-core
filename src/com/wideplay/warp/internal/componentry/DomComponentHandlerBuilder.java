 ...
 * @since 1.0
 */
class DomComponentHandlerBuilder {
    ...
    private final Log log = LogFactory.getLog(DomComponentHandlerBuilder.class);
    private static final String WARP_NAMESPACE_URI = "http://www.wideplay.com/warp/schema/warp_core.xsd";

    public DomComponentHandlerBuilder(ComponentRegistry registry) {
